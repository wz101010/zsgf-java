...
| [**fileDeleteWithHttpInfo**](FileApi.md#fileDeleteWithHttpInfo) | **DELETE** /File/{appKey} | 删除文件或文件夹 |
| [**fileRename**](FileApi.md#fileRename) | **POST** /File/{appKey}/Rename | 重命名文件或文件夹 |
| [**fileRenameWithHttpInfo**](FileApi.md#fileRenameWithHttpInfo) | **POST** /File/{appKey}/Rename | 重命名文件或文件夹 |
...
public class Example {
    public static void main(String[] args) {
        ...
        FileApi apiInstance = new FileApi(defaultClient);
        String appKey = "appKey_example"; // String | 
        String path = "path_example"; // String | 文件或文件夹路径
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        FileApi apiInstance = new FileApi(defaultClient);
        String appKey = "appKey_example"; // String | 
        String sourceName = "sourceName_example"; // String | 原文件或文件夹名称
        String destName = "destName_example"; // String | 新文件或文件夹名称
        try {
...
> BooleanApiResponse fileUpload(appKey, path, _file)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            BooleanApiResponse result = apiInstance.fileUpload(appKey, path, _file);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<BooleanApiResponse> fileUpload fileUploadWithHttpInfo(appKey, path, _file)
...
public class Example {
    public static void main(String[] args) {
        ...
        File _file = new File("/path/to/file"); // File | 上传的文件
        try {
            ApiResponse<BooleanApiResponse> response = apiInstance.fileUploadWithHttpInfo(appKey, path, _file);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
