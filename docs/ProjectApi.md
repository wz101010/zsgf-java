...
> ApiResponse<JObjectApiResult> project projectWithHttpInfo(id)
...
> JObjectApiResult projectDelete(id)
...
> ApiResponse<JObjectApiResult> projectDelete projectDeleteWithHttpInfo(id)
...
> JObjectApiResult projectPost(project)
...
> ApiResponse<JObjectApiResult> projectPost projectPostWithHttpInfo(project)
...
> JObjectApiResult projectPut(id, project)
...
> ApiResponse<JObjectApiResult> projectPut projectPutWithHttpInfo(id, project)
...
> JObjectApiResult projects(skip, take)
...
> ApiResponse<JObjectApiResult> projects projectsWithHttpInfo(skip, take)
