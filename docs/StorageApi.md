...
| [**storageBatchUpdateWithHttpInfo**](StorageApi.md#storageBatchUpdateWithHttpInfo) | **PUT** /Storage/{appKey}/{table}/batch-update | 批量更新指定条件的数据 |
...
> BooleanApiResponse storageBatchUpdate(table, filter, appKey, requestBody, replace)
...
public class Example {
    public static void main(String[] args) {
        ...
        StorageApi apiInstance = new StorageApi(defaultClient);
        String table = "table_example"; // String | 表名称
        String filter = "filter_example"; // String | 查询条件
        String appKey = "appKey_example"; // String | 
        List<Object> requestBody = null; // List<Object> | 更新的字段
        Boolean replace = false; // Boolean | 是否为全量替换，默认为 false
        try {
            BooleanApiResponse result = apiInstance.storageBatchUpdate(table, filter, appKey, requestBody, replace);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StorageApi#storageBatchUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## storageBatchUpdateWithHttpInfo

> ApiResponse<BooleanApiResponse> storageBatchUpdate storageBatchUpdateWithHttpInfo(table, filter, appKey, requestBody, replace)
