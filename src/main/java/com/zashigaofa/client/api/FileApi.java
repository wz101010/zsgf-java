...
public class FileApi {
   ...
   * 将指定的文件或文件夹重命名
   * @param appKey  (required)
   * @param sourceName 原文件或文件夹名称 (optional)
   * @param destName 新文件或文件夹名称 (optional)
   * @return BooleanApiResponse
   * @throws ApiException if fails to make API call
   */
   ...
   * @throws ApiException if fails to make API call
   */
  public BooleanApiResponse fileUpload(String appKey, String path, File _file) throws ApiException {
    ApiResponse<BooleanApiResponse> localVarResponse = fileUploadWithHttpInfo(appKey, path, _file);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BooleanApiResponse> fileUploadWithHttpInfo(String appKey, String path, File _file) throws ApiException {
