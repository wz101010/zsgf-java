 ...
 */
@JsonPropertyOrder({
  UserFollowingResult.JSON_PROPERTY_TOTAL_FOLLOWERS,
  UserFollowingResult.JSON_PROPERTY_DATA
})
...
public class UserFollowingResult {
  ...
  public UserFollowingResult totalFollowers(@javax.annotation.Nullable Long totalFollowers) {
  ...
  public UserFollowingResult data(@javax.annotation.Nullable List<FollowerModel> data) {
    this.data = JsonNullable.<List<FollowerModel>>of(data);
    return this;
  }

  public UserFollowingResult addDataItem(FollowerModel dataItem) {
  ...
  /**
   * Return true if this UserFollowingResult object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UserFollowingResult userFollowingResult = (UserFollowingResult) o;
    return Objects.equals(this.totalFollowers, userFollowingResult.totalFollowers) &&
        equalsNullable(this.data, userFollowingResult.data);
  }
