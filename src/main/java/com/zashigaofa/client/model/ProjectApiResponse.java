 ...
 */
@JsonPropertyOrder({
  ProjectApiResponse.JSON_PROPERTY_CODE,
  ProjectApiResponse.JSON_PROPERTY_DATA,
  ProjectApiResponse.JSON_PROPERTY_ERROR
})
...
public class ProjectApiResponse {
  ...
  public ProjectApiResponse() { 
  }

  public ProjectApiResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ProjectApiResponse data(@javax.annotation.Nullable Project data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable Project data) {
    this.data = data;
  }


  public ProjectApiResponse error(@javax.annotation.Nullable String error) {
  ...
  /**
   * Return true if this ProjectApiResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProjectApiResponse projectApiResponse = (ProjectApiResponse) o;
    return Objects.equals(this.code, projectApiResponse.code) &&
        Objects.equals(this.data, projectApiResponse.data) &&
        equalsNullable(this.error, projectApiResponse.error);
  }
