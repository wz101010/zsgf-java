 ...
 */
@JsonPropertyOrder({
  BooleanApiResponse.JSON_PROPERTY_CODE,
  BooleanApiResponse.JSON_PROPERTY_DATA,
  BooleanApiResponse.JSON_PROPERTY_ERROR
})
...
public class BooleanApiResponse {
  ...
  public BooleanApiResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public BooleanApiResponse data(@javax.annotation.Nullable Boolean data) {
    this.data = data;
    return this;
  }
  ...
  public BooleanApiResponse error(@javax.annotation.Nullable String error) {
  ...
  /**
   * Return true if this BooleanApiResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, booleanApiResponse.code) &&
        Objects.equals(this.data, booleanApiResponse.data) &&
        equalsNullable(this.error, booleanApiResponse.error);
  }
