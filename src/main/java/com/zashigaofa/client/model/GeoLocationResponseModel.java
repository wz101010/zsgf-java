...
public class GeoLocationResponseModel {
  ...
  private JsonNullable<String> locationType = JsonNullable.<String>undefined();
  ...
  public GeoLocationResponseModel latitude(@javax.annotation.Nullable Double latitude) {
  ...
  public GeoLocationResponseModel longitude(@javax.annotation.Nullable Double longitude) {
  ...
  public GeoLocationResponseModel locationType(@javax.annotation.Nullable String locationType) {
    this.locationType = JsonNullable.<String>of(locationType);
    return this;
  }
  ...
  public JsonNullable<String> getLocationType_JsonNullable() {
    return locationType;
  }
  
  @JsonProperty(JSON_PROPERTY_LOCATION_TYPE)
  public void setLocationType_JsonNullable(JsonNullable<String> locationType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.latitude, geoLocationResponseModel.latitude) &&
        Objects.equals(this.longitude, geoLocationResponseModel.longitude) &&
        equalsNullable(this.locationName, geoLocationResponseModel.locationName) &&
        equalsNullable(this.locationType, geoLocationResponseModel.locationType) &&
        ...
        Objects.equals(this.enable, geoLocationResponseModel.enable) &&
        Objects.equals(this.showIndex, geoLocationResponseModel.showIndex) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(latitude, longitude, hashCodeNullable(locationName), hashCodeNullable(locationType), hashCodeNullable(recipientName), hashCodeNullable(phoneNumber), hashCodeNullable(email), hashCodeNullable(country), hashCodeNullable(state), hashCodeNullable(city), hashCodeNullable(district), hashCodeNullable(street), hashCodeNullable(zipCode), hashCodeNullable(address), hashCodeNullable(mapType), hashCodeNullable(remark), hashCodeNullable(tags), enable, showIndex, createDate, lastUpdate, id);
  }
