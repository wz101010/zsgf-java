...
import com.zashigaofa.client.model.MySqlGeometry;
 ...
 */
@JsonPropertyOrder({
  GeoLocation.JSON_PROPERTY_ID,
  GeoLocation.JSON_PROPERTY_BIZ_CODE,
  GeoLocation.JSON_PROPERTY_BIZ_I_D,
  GeoLocation.JSON_PROPERTY_COORDINATES,
  GeoLocation.JSON_PROPERTY_LOCATION_NAME,
  GeoLocation.JSON_PROPERTY_LOCATION_TYPE,
  GeoLocation.JSON_PROPERTY_RECIPIENT_NAME,
  GeoLocation.JSON_PROPERTY_PHONE_NUMBER,
  GeoLocation.JSON_PROPERTY_EMAIL,
  GeoLocation.JSON_PROPERTY_COUNTRY,
  GeoLocation.JSON_PROPERTY_STATE,
  GeoLocation.JSON_PROPERTY_CITY,
  GeoLocation.JSON_PROPERTY_DISTRICT,
  GeoLocation.JSON_PROPERTY_STREET,
  GeoLocation.JSON_PROPERTY_ZIP_CODE,
  GeoLocation.JSON_PROPERTY_ADDRESS,
  GeoLocation.JSON_PROPERTY_MAP_TYPE,
  GeoLocation.JSON_PROPERTY_REMARK,
  GeoLocation.JSON_PROPERTY_TAGS,
  GeoLocation.JSON_PROPERTY_ENABLE,
  GeoLocation.JSON_PROPERTY_SHOW_INDEX,
  GeoLocation.JSON_PROPERTY_CREATE_DATE,
  GeoLocation.JSON_PROPERTY_LAST_UPDATE
})
...
public class GeoLocation {
  ...
  public static final String JSON_PROPERTY_BIZ_I_D = "bizID";
  @javax.annotation.Nonnull
  private Long bizID;

  public static final String JSON_PROPERTY_COORDINATES = "coordinates";
  @javax.annotation.Nonnull
  private MySqlGeometry coordinates;
  ...
  public GeoLocation id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public GeoLocation bizCode(@javax.annotation.Nonnull String bizCode) {
  ...
  @JsonProperty(JSON_PROPERTY_BIZ_CODE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBizCode(@javax.annotation.Nonnull String bizCode) {
    this.bizCode = bizCode;
  }


  public GeoLocation bizID(@javax.annotation.Nonnull Long bizID) {
    this.bizID = bizID;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_BIZ_I_D)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(JSON_PROPERTY_BIZ_I_D)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBizID(@javax.annotation.Nonnull Long bizID) {
    this.bizID = bizID;
  }


  public GeoLocation coordinates(@javax.annotation.Nonnull MySqlGeometry coordinates) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public MySqlGeometry getCoordinates() {
    return coordinates;
  }
  ...
  @JsonProperty(JSON_PROPERTY_COORDINATES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCoordinates(@javax.annotation.Nonnull MySqlGeometry coordinates) {
    this.coordinates = coordinates;
  }


  public GeoLocation locationName(@javax.annotation.Nullable String locationName) {
  ...
  public GeoLocation locationType(@javax.annotation.Nullable String locationType) {
  ...
  public GeoLocation recipientName(@javax.annotation.Nullable String recipientName) {
  ...
  public GeoLocation phoneNumber(@javax.annotation.Nullable String phoneNumber) {
  ...
  public GeoLocation email(@javax.annotation.Nullable String email) {
  ...
  public GeoLocation country(@javax.annotation.Nullable String country) {
  ...
  public GeoLocation state(@javax.annotation.Nullable String state) {
  ...
  public GeoLocation city(@javax.annotation.Nullable String city) {
  ...
  public GeoLocation district(@javax.annotation.Nullable String district) {
  ...
  public GeoLocation street(@javax.annotation.Nullable String street) {
  ...
  public GeoLocation zipCode(@javax.annotation.Nullable String zipCode) {
  ...
  public GeoLocation address(@javax.annotation.Nullable String address) {
  ...
  public GeoLocation mapType(@javax.annotation.Nullable String mapType) {
  ...
  public GeoLocation remark(@javax.annotation.Nullable String remark) {
  ...
  public GeoLocation tags(@javax.annotation.Nullable String tags) {
  ...
  public GeoLocation enable(@javax.annotation.Nullable Boolean enable) {
    this.enable = enable;
    return this;
  }
  ...
  public GeoLocation showIndex(@javax.annotation.Nullable Integer showIndex) {
  ...
  public GeoLocation createDate(@javax.annotation.Nullable OffsetDateTime createDate) {
  ...
  public GeoLocation lastUpdate(@javax.annotation.Nullable OffsetDateTime lastUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, geoLocation.id) &&
        Objects.equals(this.bizCode, geoLocation.bizCode) &&
        Objects.equals(this.bizID, geoLocation.bizID) &&
        Objects.equals(this.coordinates, geoLocation.coordinates) &&
        equalsNullable(this.locationName, geoLocation.locationName) &&
        equalsNullable(this.locationType, geoLocation.locationType) &&
        equalsNullable(this.recipientName, geoLocation.recipientName) &&
        equalsNullable(this.phoneNumber, geoLocation.phoneNumber) &&
        equalsNullable(this.email, geoLocation.email) &&
        equalsNullable(this.country, geoLocation.country) &&
        equalsNullable(this.state, geoLocation.state) &&
        equalsNullable(this.city, geoLocation.city) &&
        equalsNullable(this.district, geoLocation.district) &&
        equalsNullable(this.street, geoLocation.street) &&
        equalsNullable(this.zipCode, geoLocation.zipCode) &&
        equalsNullable(this.address, geoLocation.address) &&
        equalsNullable(this.mapType, geoLocation.mapType) &&
        equalsNullable(this.remark, geoLocation.remark) &&
        equalsNullable(this.tags, geoLocation.tags) &&
        Objects.equals(this.enable, geoLocation.enable) &&
        Objects.equals(this.showIndex, geoLocation.showIndex) &&
        Objects.equals(this.createDate, geoLocation.createDate) &&
        Objects.equals(this.lastUpdate, geoLocation.lastUpdate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, bizCode, bizID, coordinates, hashCodeNullable(locationName), hashCodeNullable(locationType), hashCodeNullable(recipientName), hashCodeNullable(phoneNumber), hashCodeNullable(email), hashCodeNullable(country), hashCodeNullable(state), hashCodeNullable(city), hashCodeNullable(district), hashCodeNullable(street), hashCodeNullable(zipCode), hashCodeNullable(address), hashCodeNullable(mapType), hashCodeNullable(remark), hashCodeNullable(tags), enable, showIndex, createDate, lastUpdate);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `bizID` to the URL query string
    if (getBizID() != null) {
      joiner.add(String.format("%sbizID%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBizID()))));
    }
