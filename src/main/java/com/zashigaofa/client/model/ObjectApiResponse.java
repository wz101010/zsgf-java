 ...
 */
@JsonPropertyOrder({
  ObjectApiResponse.JSON_PROPERTY_CODE,
  ObjectApiResponse.JSON_PROPERTY_DATA,
  ObjectApiResponse.JSON_PROPERTY_ERROR
})
...
public class ObjectApiResponse {
  ...
  public ObjectApiResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ObjectApiResponse data(@javax.annotation.Nullable Object data) {
  ...
  public ObjectApiResponse error(@javax.annotation.Nullable String error) {
  ...
  /**
   * Return true if this ObjectApiResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ObjectApiResponse objectApiResponse = (ObjectApiResponse) o;
    return Objects.equals(this.code, objectApiResponse.code) &&
        equalsNullable(this.data, objectApiResponse.data) &&
        equalsNullable(this.error, objectApiResponse.error);
  }
