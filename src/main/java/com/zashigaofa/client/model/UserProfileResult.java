 ...
 */
@JsonPropertyOrder({
  UserProfileResult.JSON_PROPERTY_USER,
...
public class UserProfileResult {
  ...
  public UserProfileResult user(@javax.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, userProfileResult.user) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(user, hashCodeNullable(currencies), hashCodeNullable(role));
  }
