 ...
 */
@JsonPropertyOrder({
  UserProfileResult.JSON_PROPERTY_APP_KEY,
  UserProfileResult.JSON_PROPERTY_PLATFORM,
  UserProfileResult.JSON_PROPERTY_UNION_I_D,
  UserProfileResult.JSON_PROPERTY_PHONE,
  UserProfileResult.JSON_PROPERTY_CREATE_DATE,
  UserProfileResult.JSON_PROPERTY_USER_NAME,
  UserProfileResult.JSON_PROPERTY_PHONE_IS_VALID,
  UserProfileResult.JSON_PROPERTY_DATA,
  UserProfileResult.JSON_PROPERTY_EMAIL,
  UserProfileResult.JSON_PROPERTY_EMAIL_IS_VALID,
  UserProfileResult.JSON_PROPERTY_LAST_UPDATE,
  UserProfileResult.JSON_PROPERTY_NICK_NAME,
  UserProfileResult.JSON_PROPERTY_ID,
  UserProfileResult.JSON_PROPERTY_AVATAR,
  UserProfileResult.JSON_PROPERTY_CURRENCIES,
  UserProfileResult.JSON_PROPERTY_ROLE
})
...
public class UserProfileResult {
  ...
  public UserProfileResult appKey(@javax.annotation.Nullable String appKey) {
  ...
  public UserProfileResult platform(@javax.annotation.Nullable String platform) {
  ...
  public UserProfileResult unionID(@javax.annotation.Nullable String unionID) {
  ...
  public UserProfileResult phone(@javax.annotation.Nullable String phone) {
  ...
  public UserProfileResult createDate(@javax.annotation.Nullable OffsetDateTime createDate) {
  ...
  public UserProfileResult userName(@javax.annotation.Nullable String userName) {
  ...
  public UserProfileResult phoneIsValid(@javax.annotation.Nullable Boolean phoneIsValid) {
  ...
  public UserProfileResult data(@javax.annotation.Nullable String data) {
  ...
  public UserProfileResult email(@javax.annotation.Nullable String email) {
  ...
  public UserProfileResult emailIsValid(@javax.annotation.Nullable Boolean emailIsValid) {
  ...
  public UserProfileResult lastUpdate(@javax.annotation.Nullable OffsetDateTime lastUpdate) {
  ...
  public UserProfileResult nickName(@javax.annotation.Nullable String nickName) {
  ...
  public UserProfileResult id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public UserProfileResult avatar(@javax.annotation.Nullable String avatar) {
  ...
  public UserProfileResult currencies(@javax.annotation.Nullable List<UserCurrency> currencies) {
    this.currencies = JsonNullable.<List<UserCurrency>>of(currencies);
    return this;
  }

  public UserProfileResult addCurrenciesItem(UserCurrency currenciesItem) {
  ...
  public UserProfileResult role(@javax.annotation.Nullable String role) {
  ...
  /**
   * Return true if this UserProfileResult object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UserProfileResult userProfileResult = (UserProfileResult) o;
    return equalsNullable(this.appKey, userProfileResult.appKey) &&
        equalsNullable(this.platform, userProfileResult.platform) &&
        equalsNullable(this.unionID, userProfileResult.unionID) &&
        equalsNullable(this.phone, userProfileResult.phone) &&
        Objects.equals(this.createDate, userProfileResult.createDate) &&
        equalsNullable(this.userName, userProfileResult.userName) &&
        Objects.equals(this.phoneIsValid, userProfileResult.phoneIsValid) &&
        equalsNullable(this.data, userProfileResult.data) &&
        equalsNullable(this.email, userProfileResult.email) &&
        Objects.equals(this.emailIsValid, userProfileResult.emailIsValid) &&
        Objects.equals(this.lastUpdate, userProfileResult.lastUpdate) &&
        equalsNullable(this.nickName, userProfileResult.nickName) &&
        Objects.equals(this.id, userProfileResult.id) &&
        equalsNullable(this.avatar, userProfileResult.avatar) &&
        equalsNullable(this.currencies, userProfileResult.currencies) &&
        equalsNullable(this.role, userProfileResult.role);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(appKey), hashCodeNullable(platform), hashCodeNullable(unionID), hashCodeNullable(phone), createDate, hashCodeNullable(userName), phoneIsValid, hashCodeNullable(data), hashCodeNullable(email), emailIsValid, lastUpdate, hashCodeNullable(nickName), id, hashCodeNullable(avatar), hashCodeNullable(currencies), hashCodeNullable(role));
  }
