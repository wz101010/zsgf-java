 ...
 */
@JsonPropertyOrder({
  AppUserListResponse.JSON_PROPERTY_ID,
  AppUserListResponse.JSON_PROPERTY_UNION_I_D,
  AppUserListResponse.JSON_PROPERTY_PLATFORM,
  AppUserListResponse.JSON_PROPERTY_USER_NAME,
  AppUserListResponse.JSON_PROPERTY_NICK_NAME,
  AppUserListResponse.JSON_PROPERTY_EMAIL,
  AppUserListResponse.JSON_PROPERTY_PHONE,
  AppUserListResponse.JSON_PROPERTY_AVATAR,
  AppUserListResponse.JSON_PROPERTY_ROLE,
  AppUserListResponse.JSON_PROPERTY_ROLE_I_D,
  AppUserListResponse.JSON_PROPERTY_CREATE_DATE,
  AppUserListResponse.JSON_PROPERTY_LAST_UPDATE
})
...
public class AppUserListResponse {
  ...
  public static final String JSON_PROPERTY_ROLE_I_D = "roleID";
  @javax.annotation.Nullable
  private Long roleID;
  ...
  public AppUserListResponse id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public AppUserListResponse unionID(@javax.annotation.Nullable String unionID) {
  ...
  public AppUserListResponse platform(@javax.annotation.Nullable String platform) {
  ...
  public AppUserListResponse userName(@javax.annotation.Nullable String userName) {
  ...
  public AppUserListResponse nickName(@javax.annotation.Nullable String nickName) {
  ...
  public AppUserListResponse email(@javax.annotation.Nullable String email) {
  ...
  public AppUserListResponse phone(@javax.annotation.Nullable String phone) {
  ...
  public AppUserListResponse avatar(@javax.annotation.Nullable String avatar) {
  ...
  public AppUserListResponse role(@javax.annotation.Nullable String role) {
  ...
  public AppUserListResponse roleID(@javax.annotation.Nullable Long roleID) {
    this.roleID = roleID;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ROLE_I_D)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public AppUserListResponse createDate(@javax.annotation.Nullable OffsetDateTime createDate) {
  ...
  public AppUserListResponse lastUpdate(@javax.annotation.Nullable OffsetDateTime lastUpdate) {
  ...
  /**
   * Return true if this AppUserListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AppUserListResponse appUserListResponse = (AppUserListResponse) o;
    return Objects.equals(this.id, appUserListResponse.id) &&
        equalsNullable(this.unionID, appUserListResponse.unionID) &&
        equalsNullable(this.platform, appUserListResponse.platform) &&
        equalsNullable(this.userName, appUserListResponse.userName) &&
        equalsNullable(this.nickName, appUserListResponse.nickName) &&
        equalsNullable(this.email, appUserListResponse.email) &&
        equalsNullable(this.phone, appUserListResponse.phone) &&
        equalsNullable(this.avatar, appUserListResponse.avatar) &&
        equalsNullable(this.role, appUserListResponse.role) &&
        Objects.equals(this.roleID, appUserListResponse.roleID) &&
        Objects.equals(this.createDate, appUserListResponse.createDate) &&
        Objects.equals(this.lastUpdate, appUserListResponse.lastUpdate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(unionID), hashCodeNullable(platform), hashCodeNullable(userName), hashCodeNullable(nickName), hashCodeNullable(email), hashCodeNullable(phone), hashCodeNullable(avatar), hashCodeNullable(role), roleID, createDate, lastUpdate);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRoleID() != null) {
      joiner.add(String.format("%sroleID%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRoleID()))));
    }
