 ...
 */
@JsonPropertyOrder({
  ServiceItemApiResponse.JSON_PROPERTY_CODE,
  ServiceItemApiResponse.JSON_PROPERTY_DATA,
  ServiceItemApiResponse.JSON_PROPERTY_ERROR
})
...
public class ServiceItemApiResponse {
  ...
  public ServiceItemApiResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ServiceItemApiResponse data(@javax.annotation.Nullable ServiceItem data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable ServiceItem data) {
    this.data = data;
  }


  public ServiceItemApiResponse error(@javax.annotation.Nullable String error) {
  ...
  /**
   * Return true if this ServiceItemApiResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ServiceItemApiResponse serviceItemApiResponse = (ServiceItemApiResponse) o;
    return Objects.equals(this.code, serviceItemApiResponse.code) &&
        Objects.equals(this.data, serviceItemApiResponse.data) &&
        equalsNullable(this.error, serviceItemApiResponse.error);
  }
