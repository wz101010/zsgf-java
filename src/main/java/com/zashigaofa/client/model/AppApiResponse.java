 ...
 */
@JsonPropertyOrder({
  AppApiResponse.JSON_PROPERTY_CODE,
  AppApiResponse.JSON_PROPERTY_DATA,
  AppApiResponse.JSON_PROPERTY_ERROR
})
...
public class AppApiResponse {
  ...
  public AppApiResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public AppApiResponse data(@javax.annotation.Nullable App data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable App data) {
    this.data = data;
  }


  public AppApiResponse error(@javax.annotation.Nullable String error) {
  ...
  /**
   * Return true if this AppApiResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, appApiResponse.code) &&
        Objects.equals(this.data, appApiResponse.data) &&
        equalsNullable(this.error, appApiResponse.error);
  }
