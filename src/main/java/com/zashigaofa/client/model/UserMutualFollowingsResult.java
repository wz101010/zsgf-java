 ...
 */
@JsonPropertyOrder({
  UserMutualFollowingsResult.JSON_PROPERTY_TOTAL_FOLLOWERS,
  UserMutualFollowingsResult.JSON_PROPERTY_DATA
})
...
public class UserMutualFollowingsResult {
  ...
  public UserMutualFollowingsResult() { 
  }

  public UserMutualFollowingsResult totalFollowers(@javax.annotation.Nullable Long totalFollowers) {
  ...
  public UserMutualFollowingsResult data(@javax.annotation.Nullable List<CommonFriendModel> data) {
    this.data = JsonNullable.<List<CommonFriendModel>>of(data);
    return this;
  }

  public UserMutualFollowingsResult addDataItem(CommonFriendModel dataItem) {
  ...
  /**
   * Return true if this UserMutualFollowingsResult object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UserMutualFollowingsResult userMutualFollowingsResult = (UserMutualFollowingsResult) o;
    return Objects.equals(this.totalFollowers, userMutualFollowingsResult.totalFollowers) &&
        equalsNullable(this.data, userMutualFollowingsResult.data);
  }
