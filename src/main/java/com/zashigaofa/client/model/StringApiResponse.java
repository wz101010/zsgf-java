 ...
 */
@JsonPropertyOrder({
  StringApiResponse.JSON_PROPERTY_CODE,
  StringApiResponse.JSON_PROPERTY_DATA,
  StringApiResponse.JSON_PROPERTY_ERROR
})
...
public class StringApiResponse {
  ...
  public StringApiResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public StringApiResponse data(@javax.annotation.Nullable String data) {
  ...
  public StringApiResponse error(@javax.annotation.Nullable String error) {
  ...
  /**
   * Return true if this StringApiResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, stringApiResponse.code) &&
        equalsNullable(this.data, stringApiResponse.data) &&
        equalsNullable(this.error, stringApiResponse.error);
  }
